        ...
        <div className='navbar-announcement-animation-container'>
            <div className="navbar-announcement-animation-subcontainer">
                <ul className='navbar-announcement-ul'>
                    ...
                    <li className="item-6 text-white flex flex-row space-x-4 justify-center items-center pb-4 cursor-pointer" onClick={()=> {alert("Registeration Form To Be out soon!")}}>
                        <BsFillArrowUpRightCircleFill className='text-xl md:text-2xl text-gray-300' /><p className='gradient-text-animation text-2xl md:text-2xl lg:text-3xl font-bold'>KODIKON 3.0 ✨</p></li>
                </ul>
            </div>
        </div>
    )
