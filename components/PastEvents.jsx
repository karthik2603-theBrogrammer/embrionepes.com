  ...
  return (
    <div className="p-5 md:p-[110px] flex flex-col relative">
      ...
      {activeEvent === null ? (
        ...
        <div className="my-5">
          <p className="text-white text-2xl md:text-6xl text-center my-6 ">{eventDetails?.eventName}</p>
          <p className="text-white text-1xl md:text-2xl  text-center my-4">{eventDetails?.eventDescription}</p>
