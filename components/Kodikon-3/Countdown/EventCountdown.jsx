    ...
    return (
      <div className="h-fit my-32 px-2">
        <h1 className="text-white text-5xl md:text-6xl lg:text-8xl text-center">
          <span className="gradient-text-animation">Kodikon 3.0</span>{" "}
          Registration Open!
        </h1>
        <div className="w-full h-fit flex items-center justify-center">
          <a
            href="https://hack2skill.com/hack/kodikon3?utm_source=poster&utm_medium=campaign"
          >
    ...
    return (
      <div className="h-fit my-32 px-2 flex flex-col items-center justify-center gap-y-8">
        ...
        <div className="flex gap-3 text-gray-200 md:text-5xl">
          <div>
            <span className="text-4xl md:text-6xl lg:text-7xl text-center bg-clip-text">
              {days}
            </span>
            days
          </div>
