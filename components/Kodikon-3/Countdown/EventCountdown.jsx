...
const renderer = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
        ...
        return <div className="h-fit my-32 px-2 flex flex-col items-center justify-center gap-y-8">
            ...
            <div><span className="text-4xl md:text-6xl lg:text-8xl text-center bg-clip-text">{days}</span>days</div> 
            <div><span className="text-4xl md:text-6xl lg:text-8xl text-center bg-clip-text">{hours}</span>hours</div> 
            <div><span className="text-4xl md:text-6xl lg:text-8xl text-center bg-clip-text">{minutes}</span>min</div> 
            <div><span className="text-4xl md:text-6xl lg:text-8xl text-center bg-clip-text">{seconds}</span>sec</div>
            </div>
