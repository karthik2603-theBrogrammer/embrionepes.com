...
const Hero = () => {
  ...
  return (
    <motion.div className="flex flex-col items-center md:items-start justify-between h-[80vh] md:pt-[140px] pt-[100px] overflow-hidden">
      <motion.div
        // style={{ scale }}
      ...
      >
        ...
        <h1
          className=" text-white w-fit md:text-9xl text-[70px]  text xl:text-[260px] md:tracking-in-expand py-9"
          ref={ref}
        />
      ...
      <motion.div
        // style={{ scale }}
        className="-z-10 w-screen items-center justify-center max-w-5xl md:hidden flex relative -top-24  "
        data-aos="zoom-in"
